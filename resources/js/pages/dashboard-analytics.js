...
File: dashboard analytics Js File
*/
...
class DashboardEcommerce {
    ...
    initAnalyticsReport() {
        ...
        var chart = new ApexCharts(document.querySelector("#analytics-reports"), dataLabelOptions);
        chart.render();
    }

    initSubscriptionDistribution() {
        var options = {
    ...
    init() {
        this.initResponseTimes();
        this.initPagesInteraction();
        this.initPlatformPerspective();
        this.initUserDevices();
        this.initSatisfactionRate();
        this.initDailyVisitInsights();
        this.initSubscriptionDistribution();
        this.initAnalyticsReport();
    }
}

document.addEventListener('DOMContentLoaded', function () {
    setTimeout(() => {
        new DashboardEcommerce().init();
    }, 100);
});